...
(() => {
  ...
  /* Scroll-in animation hooks
     Content is visible by default in CSS. Elements with [data-animate] gain
     .is-visible once they enter the viewport so CSS and future enhancements
     can react without making JS responsible for content visibility. Parents
     with [data-animate-stagger] cascade their children with a short delay.

     Above-the-fold elements are marked immediately on first paint. The
